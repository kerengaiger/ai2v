...
def parse_args():
    ...
    parser.add_argument('--train', type=str, default='train_i2v_sub_u.dat', help="train file name")
    parser.add_argument('--valid', type=str, default='valid_i2v_sub_u.dat', help="validation users file name")
    parser.add_argument('--test', type=str, default='test_i2v_sub_u.dat', help="test users file name")
    parser.add_argument('--full_train', type=str, default='full_train_i2v_sub_u.dat', help="full train file name")
