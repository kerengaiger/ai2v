...
def parse_args():
    ...
    parser.add_argument('--full_train_file', type=str, default='./data/full_train_ai2v_batch_u.dat', help="full train file name")
    parser.add_argument('--train_file', type=str, default='./data/train_ai2v_batch_u.dat', help="train file name, in case of build_valid")
    parser.add_argument('--valid_file', type=str, default='./data/valid_ai2v_batch_u.dat', help="validation file name, in case of build_valid")
    parser.add_argument('--test_file', type=str, default='./data/test_ai2v_batch_u.dat', help="test file of sub users and target items")
