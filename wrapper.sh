...
function prepare_database_corpus(){
  ...
  if [ "$1" = "movielens" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/movielens_corpus.dat --line_sep :: --min_usr_len 1 --max_usr_len 1000 \
  ...
  if [ "$1" = "netflix" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/netflix_corpus.dat --line_sep , --min_usr_len 3 --max_usr_len 1000 \
  ...
  if [ "$1" = "moviesdat" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/moviesdat_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
  ...
  if [ "$1" = "yahoo" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/yahoo_all_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
      --min_items_cnt 10 --max_items_cnt 100000 --final_usr_len 4 --split_strategy "$2" --data_dir ./corpus/yahoo/
    else
      python prepare_corpus.py --input_file ./data/yahoo_all_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
      --min_items_cnt 10 --max_items_cnt 100000 --final_usr_len 3 --split_strategy "$2" --data_dir ./corpus/yahoo/
    fi
  fi

  if [ "$1" = "goodbooks" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/goodbooks_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
  ...
  if [ "$1" = "booksrec" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/booksrec_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
  ...
  if [ "$1" = "animerec" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/animerec_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
  ...
  if [ "$1" = "animerec20" ]; then
    if [ "$2" = "llo" ]; then
      python prepare_corpus.py --input_file ./data/animerec20_corpus.dat --line_sep , --min_usr_len 2 --max_usr_len 1000 \
