...
def parse_args():
    ...
    parser.add_argument('--rate_pos', type=str, default=2, help="position of rating in row")
    parser.add_argument('--date_pos', type=str, default=3, help="position of date in row")
    ...
    parser.add_argument('--min_usr_len', type=str, default=3, help="minimum number of items per user")
    parser.add_argument('--max_usr_len', type=str, default=2700, help="maximum number of items per user")
    parser.add_argument('--min_items_cnt', type=str, default=100, help="minimum numbers of users per item")
    parser.add_argument('--max_items_cnt', type=str, default=130000, help="maximum numbers of users per item")
    parser.add_argument('--final_usr_len', type=str, default=130000, help="final minimum user length")
